    ...
    <div className="min-h-screen bg-[#F3F1E8] flex items-center justify-center p-6 relative overflow-hidden font-sans">
      <style jsx global>{`
        ...
        .switch::after {
          ...
          box-shadow: 0 2px 4px rgba(22,36,31,0.12);
      ...
      <div className="relative z-10 w-full max-w-[920px] grid grid-cols-1 md:grid-cols-2 rounded-[24px] bg-[#F2EFE6] border border-[rgba(22,36,31,0.13)] overflow-hidden shadow-2xl animate-in fade-in slide-in-from-bottom-6 duration-500">
        ...
        <div className="hidden md:flex p-12 bg-[#16241F] flex-col justify-between relative text-[#F2EFE6]">
          ...
          <div className="relative h-48 w-full mt-4 flex items-center justify-center perspective-[1200px]">
            ...
            >
              ...
              <div className="relative z-10 h-full flex flex-col transform translate-z-[24px] text-[#16241F]">
                <div className="flex justify-between items-center">
                  <span className="text-[9px] font-mono text-[#324B41]">BATCH 2A</span>
                  <span className="text-[8px] font-bold px-2 py-0.5 rounded-full text-[#16241F] bg-[#E3A72F]">
                    LIVE
                  </span>
                </div>
                
                <div className="font-bold text-[14px] text-[#16241F] mt-4">HSC Physics</div>
                <div className="text-[10px] text-[#324B41] mt-0.5">Saturday · 4:00 PM</div>
                
                <div className="mt-auto flex gap-2">
                  <span className="text-[9px] font-semibold px-2 py-0.5 rounded-full text-[#16241F] bg-[rgba(22,36,31,0.06)]">18 Students</span>
                  <span className="text-[9px] font-semibold px-2 py-0.5 rounded-full text-[#16241F] bg-[rgba(22,36,31,0.06)]">Enrolled</span>
                </div>
              </div>
            </div>
            ...
            <div className="absolute top-2 right-2 bg-[#243830] text-[#E7E4D6] px-3 py-2 rounded-md flex items-center gap-1.5 text-[11px] font-bold border border-[rgba(242,239,230,0.1)] animate-bob-1">
              <Check className="w-3.5 h-3.5 text-[#5FA779]" /> Synced
            </div>
            <div className="absolute bottom-6 -left-2 bg-[#243830] text-[#E7E4D6] px-3 py-2 rounded-md flex items-center gap-1.5 text-[11px] font-bold border border-[rgba(242,239,230,0.1)] animate-bob-2">
              <AlertCircle className="w-3.5 h-3.5 text-[#E3A72F]" /> Scheduled
            </div>
          </div>
        ...
        <div className="p-8 md:p-12 flex flex-col justify-center bg-[#F2EFE6] text-[#16241F]">
          <div className="mb-8">
            <span className="text-[10px] font-bold font-mono text-[#C4880E] tracking-widest block mb-2">WELCOME BACK</span>
            <h1 className="text-2xl font-bold text-[#16241F] mb-1">Sign in to your workspace</h1>
            <p className="text-xs text-[#3A4B44]">Enter your credentials to access the dashboard.</p>
          </div>
          ...
          <form action={formAction} className="space-y-4">
            ...
            <div className="flex items-center justify-between py-1.5">
              ...
              <Link href="/forgot-password" className="text-xs font-semibold text-[#C4880E] hover:underline">
                Forgot password?
              </Link>
            </div>
          ...
          <p className="signup-note text-center mt-6 text-xs text-[#324B41]">
            New center? <Link href="/signup" className="font-bold text-[#C4880E] hover:underline">Create an account</Link>
          </p>
