      ...
      <nav className={`fixed top-0 left-0 w-full z-50 py-4 transition-all duration-300 ${
        ...
        <div className="max-w-6xl mx-auto px-6 flex items-center justify-between">
          <div className="flex items-center gap-3 font-bold text-lg text-[#202638]">
            ...
            <span className="font-bold tracking-tight text-xl font-display text-[#202638]">CoachingSync</span>
          </div>
      ...
      <footer className="py-12 border-t border-[#AEB9C9]/20 px-6">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="flex items-center gap-2.5">
            ...
            <span className="font-bold text-[#202638] tracking-tight">CoachingSync</span>
          </div>
          ...
          <div className="flex gap-6 text-xs text-[#8891A3]">
            ...
            <a href="mailto:CoachingSync@gmail.com" className="hover:text-[#202638] transition-colors">CoachingSync@gmail.com</a>
          </div>
