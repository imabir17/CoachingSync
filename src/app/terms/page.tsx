    ...
    <div className="min-h-screen bg-[#F4F7FB] text-[#F0F3F8] font-sans">
      <div className="max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="neo-raised bg-[#1B1E23] rounded-3xl p-8 md:p-12 shadow-[12px_12px_24px_#111317,-12px_-12px_24px_#252A31]">
          <h1 className="text-3xl md:text-4xl font-black text-[#F0F3F8] mb-4 tracking-tight">Terms & Conditions</h1>
          ...
          <div className="space-y-8 text-base text-[#AAB4C4] leading-relaxed">
            <section>
              <h2 className="text-xl font-bold text-[#F0F3F8] mb-4">1. Agreement to Terms</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-bold text-[#F0F3F8] mb-4">2. Intellectual Property</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-bold text-[#F0F3F8] mb-4">3. User Accounts & Responsibilities</h2>
            ...
            <section>
              <h2 className="text-xl font-bold text-[#F0F3F8] mb-4">4. Acceptable Use</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-bold text-[#F0F3F8] mb-4">5. Limitation of Liability</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-bold text-[#F0F3F8] mb-4">6. Changes to Terms</h2>
              <p>
