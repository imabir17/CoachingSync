...
export default function TermsConditions() {
  return (
    <div className="min-h-screen bg-[#F4F7FB] text-[#D4D4D4] font-sans">
      <div className="max-w-4xl mx-auto px-6 py-12">
        <Link 
          href="/login" 
          className="inline-flex items-center text-sm font-semibold text-[#CCCCCC] hover:text-blue-600 transition-colors mb-8"
        >
          <ArrowLeft className="w-4 h-4 mr-2" />
          Back to Login
        </Link>
        
        <div className="neo-raised bg-[#1E1E1E] rounded-3xl p-8 md:p-12 border border-[#3E3E42]">
          <h1 className="text-3xl md:text-4xl font-black text-[#D4D4D4] mb-4 tracking-tight">Terms & Conditions</h1>
          <p className="text-sm font-bold text-[#CCCCCC] mb-8">Last Updated: {new Date().toLocaleDateString()}</p>
          
          <div className="space-y-8 text-base text-[#CCCCCC] leading-relaxed">
            <section>
              <h2 className="text-xl font-bold text-[#D4D4D4] mb-4">1. Agreement to Terms</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-bold text-[#D4D4D4] mb-4">2. Intellectual Property</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-bold text-[#D4D4D4] mb-4">3. User Accounts & Responsibilities</h2>
            ...
            <section>
              <h2 className="text-xl font-bold text-[#D4D4D4] mb-4">4. Acceptable Use</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-bold text-[#D4D4D4] mb-4">5. Limitation of Liability</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-bold text-[#D4D4D4] mb-4">6. Changes to Terms</h2>
              <p>
