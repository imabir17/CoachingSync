export default function DashboardLoading() {
  return (
    <div className="space-y-8 animate-pulse pb-12">
      <div>
        <div className="h-8 w-48 bg-neutral-800 rounded-sm mb-2"></div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {Array.from({ length: 3 }).map((_, i) => (
          <div key={i} className="bg-neutral-900/50 border border-neutral-800/80 rounded-sm p-6 h-32 flex flex-col justify-between">
      ...
      {/* Agenda Card */}
      <div className="bg-neutral-900/50 border border-neutral-800/80 rounded-sm p-6 h-40 flex flex-col justify-between">
      ...
      <div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
          {Array.from({ length: 5 }).map((_, i) => (
            <div key={i} className="bg-neutral-900/40 border border-neutral-800/60 rounded-sm p-4 h-24 flex flex-col justify-between">
