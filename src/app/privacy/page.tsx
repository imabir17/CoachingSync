    ...
    <div className="min-h-screen bg-[#F4F7FB] text-[#D4D4D4] font-sans">
      <div className="max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="neo-raised bg-[#1E1E1E] rounded-3xl p-8 md:p-12 border border-[#3E3E42]">
          <h1 className="text-3xl md:text-4xl font-black text-[#D4D4D4] mb-4 tracking-tight">Privacy Policy</h1>
          ...
          <div className="space-y-8 text-base text-[#CCCCCC] leading-relaxed">
            <section>
              <h2 className="text-xl font-bold text-[#D4D4D4] mb-4">1. Introduction</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-bold text-[#D4D4D4] mb-4">2. Information We Collect</h2>
            ...
            <section>
              <h2 className="text-xl font-bold text-[#D4D4D4] mb-4">3. How We Use Your Information</h2>
            ...
            <section>
              <h2 className="text-xl font-bold text-[#D4D4D4] mb-4">4. Data Sharing and Disclosure</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-bold text-[#D4D4D4] mb-4">5. Data Security</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-bold text-[#D4D4D4] mb-4">6. Contact Us</h2>
              <p>
