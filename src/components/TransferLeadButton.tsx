  ...
  return (
    <div className="relative">
      <button 
        ...
        className="flex items-center space-x-2 bg-neutral-800 hover:bg-neutral-700 text-white px-3 py-1.5 rounded-sm text-sm font-medium transition-colors"
      >
      ...
      {isOpen && (
        <div className="absolute left-0 md:left-auto md:right-0 mt-2 w-64 bg-neutral-900 border border-neutral-800 rounded-sm shadow-2xl p-4 z-50">
          <h4 className="text-sm font-medium text-white mb-3">Transfer to Counselor</h4>
          <select 
            value={selectedId}
            onChange={(e) => setSelectedId(e.target.value)}
            className="w-full bg-neutral-950 border border-neutral-700 rounded-sm p-2 text-sm text-white mb-3 focus:ring-1 focus:ring-blue-500"
          >
          ...
          <div className="flex justify-end space-x-2">
            ...
            <button 
              ...
              className="bg-blue-600 hover:bg-blue-700 text-white px-3 py-1.5 rounded-sm text-xs font-medium disabled:opacity-50"
            >
